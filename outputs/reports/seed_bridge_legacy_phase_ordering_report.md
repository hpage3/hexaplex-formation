...
- unit 4: angular_phase_order_score formed mean is not higher than loose mean; treated as non-activating for formed-like ordering
- unit 5: angular_phase_order_score formed mean is not higher than loose mean; treated as non-activating for formed-like ordering
- unit 6: angular_phase_order_score formed mean is not higher than loose mean; treated as non-activating for formed-like ordering
- unit 7: angular_phase_order_score formed mean is not higher than loose mean; treated as non-activating for formed-like ordering
...
| 5 | rmsd_formedness_score | CYP_MEP_contact_fraction_vs_target | axial_register_score | ambiguous | rmsd_formedness_score -> CYP_MEP_contact_fraction_vs_target -> axial_register_score -> compactness_score -> contact_fraction_vs_target |
| 6 | CYP_MEP_contact_fraction_vs_target | compactness_score | contact_fraction_vs_target | ambiguous | CYP_MEP_contact_fraction_vs_target -> compactness_score -> contact_fraction_vs_target -> seed_formation_score -> axial_register_score |
| 7 | compactness_score | CYP_MEP_contact_fraction_vs_target | axial_register_score | ambiguous | compactness_score -> CYP_MEP_contact_fraction_vs_target -> axial_register_score -> contact_fraction_vs_target -> rmsd_formedness_score |

Ordering table uses the primary threshold fraction `0.75`.

## Plots

- `outputs/seed_formation/plots/seed_bridge_legacy_phase/seed_bridge_mean_trajectories_unit4.png`
- `outputs/seed_formation/plots/seed_bridge_legacy_phase/seed_bridge_activation_times_unit4.png`
- `outputs/seed_formation/plots/seed_bridge_legacy_phase/seed_bridge_mean_trajectories_unit5.png`
- `outputs/seed_formation/plots/seed_bridge_legacy_phase/seed_bridge_activation_times_unit5.png`
- `outputs/seed_formation/plots/seed_bridge_legacy_phase/seed_bridge_mean_trajectories_unit6.png`
- `outputs/seed_formation/plots/seed_bridge_legacy_phase/seed_bridge_activation_times_unit6.png`
- `outputs/seed_formation/plots/seed_bridge_legacy_phase/seed_bridge_mean_trajectories_unit7.png`
- `outputs/seed_formation/plots/seed_bridge_legacy_phase/seed_bridge_activation_times_unit7.png`
- `outputs/seed_formation/plots/seed_bridge_legacy_phase/seed_bridge_feature_ordering_heatmap.png`
- `outputs/seed_formation/plots/seed_bridge_legacy_phase/seed_bridge_first_feature_frequency.png`
- `outputs/seed_formation/plots/seed_bridge_legacy_phase/seed_bridge_mean_trajectories_4_vs_7.png`
